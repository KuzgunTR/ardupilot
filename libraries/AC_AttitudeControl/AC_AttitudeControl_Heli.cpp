...
float AC_AttitudeControl_Heli::rate_target_to_motor_yaw(float rate_yaw_actual_rads, float rate_target_rads)
{
    ...
    float pid = _pid_rate_yaw.update_all(rate_target_rads, rate_yaw_actual_rads, _dt, 1.0f, _motors.limit.yaw, !((AP_MotorsHeli&)_motors).rotor_runup_complete()) + _actuator_sysid.z;
